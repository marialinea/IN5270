...
print("b0 = ", sym.simplify(sym.integrate(b0, (x, 1-2*h, 1))), "- C(1-h)/2h*h - D*", sym.simplify(sym.integrate(d_psi0, (x,1-2*h,1))))
print("b1 = ", sym.simplify(sym.integrate(b1, (x, 1-2*h, 1))), "- C(2h-1)/h*h - D*", sym.simplify(sym.integrate(d_psi1, (x,1-2*h,1))))
print("b2 = ", sym.simplify(sym.integrate(b2, (x, 1-2*h, 1))), "- C(1-3h+2*h*h)/2h*h - D*", sym.simplify(sym.integrate(d_psi2, (x,1-2*h,1))))
